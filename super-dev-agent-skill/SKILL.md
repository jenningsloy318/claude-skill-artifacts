...
/adversarial-review - Multi-lens adversarial challenge
...
# Architecture & Design
/architecture-design - Architecture design with ADRs
/ui-ux-design - UI/UX design specifications
...
# Execution
/execute - Dev + QA parallel execution
/golang - Go development specialist

# Reporting
/usage-report - View usage statistics
```
...
**MANDATORY RULE: From Stage 3 onwards, Team Lead MUST ALWAYS use Task tool to spawn agents. NEVER do detailed tasks directly.**
...
**KEY RULE:** If a stage requires work (Stage 3-11.5), Team Lead MUST use Task tool to spawn the appropriate agent. NEVER do the work directly.
...
### Option Presentation
Stages 4, 6.3, 6.5 require presenting 3-5 options to user for selection.
...
- **Dev Rules**: Load dev-rules for coding standards
- **TDD Workflow**: Load tdd-guide for test-driven development
- **Security Review**: Load security-reviewer for security analysis
