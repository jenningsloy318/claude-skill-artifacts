...
- **Always use relative paths** when referencing files - use paths relative to the current spec directory (e.g., `./01-requirements.md`) instead of absolute paths like `/home/user/project/...`
